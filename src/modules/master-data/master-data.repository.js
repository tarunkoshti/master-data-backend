...
const TABLE_MAP = {
    ...
    'subcastes': { table: 'subcastes', parentCol: 'community_id' },
    'states': { table: 'states', parentCol: 'country_id' },
    'relations': { table: 'relations', parentCol: null },
    'family_status': { table: 'family_status', parentCol: null },
    'family_type': { table: 'family_type', parentCol: null },
    'family_values': { table: 'family_values', parentCol: null },
    ...
    'gotras': { table: 'gotras', parentCol: 'community_id' },
    'community': { table: 'community', parentCol: 'religion_id' },
    'religion': { table: 'religion', parentCol: null },
